...
global.utils = require("./Sagor.js");
global.loading = require("./Sagor.js");
...
try {
  ...
  return logger.loader(`cant read ${chalk.blueBright('Sagor')} file`, "error");
}
try {
